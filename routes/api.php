...
Route::group(['middleware' => ['auth:sanctum']], function () {
  ...
  Route::get('/list/report/deposit/chart/bar/department', [ReportController::class, 'depositReportChartDepartment']);
...
Route::get('/contributors/search/{name}', [ContributorController::class, 'search']);
