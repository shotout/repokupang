        ...
        <form>
          <div class="row">
            <div class="col-md-6">
              <div class="mt-2 mb-2">
                <p>Report name</p>
                <input format="text" class="form-control" v-model="report_name" placeholder="Enter name.." />
              </div>
              <div class="form-group">
                <label for="">Filter By</label>
                <select class="form-control" id="filter" v-model="form.filter" aria-describedby="filterError"
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <select class="form-control" id="sort" v-model="form.sort" aria-describedby="sortError">
          ...
          <div class="row">
            <div class="col-md-6">
              <div v-if="fil_date">
                <div class="form-group">
                  ...
                  <input type="date" name="start_date" class="form-control" aria-describedby="start_dateError"
                ...
                <div class="form-group">
                  <input type="date" name="end_date" class="form-control" aria-describedby="end_dateError"
              ...
              <div class="form-group" v-if="fil_category">
                ...
                <select class="form-control" aria-describedby="categoryError" v-model="form.category">
              ...
              <div class="form-group" v-if="fil_division">
                ...
                <select class="form-control" aria-describedby="divisionError" v-model="form.division">
                  <option value="" selected disabled>-- Select Division --</option>
                  <option v-for="(division, index) in divisions" :key="index" :value="division.division_name">{{
              ...
              <div class="form-group" v-if="fil_department">
                <!-- <label for="category">Division</label> -->
                <select class="form-control" aria-describedby="divisionError" v-model="form.department">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <select class="form-control" id="order" v-model="form.order" aria-describedby="orderError">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <b-button variant="info" class="btn-sm float-right ml-1" v-b-tooltip.hover title="Export as JSON"
                v-on:click.prevent="downloadPDF('generate_JSON')"><i class="fas fa-fw fa-file-code"></i></b-button>

              <b-button variant="success" class="btn-sm float-right ml-1" v-b-tooltip.hover title="Export as Excel"
                v-on:click.prevent="downloadPDF('download_EXCEL')"><i class="fas fa-fw fa-file-excel"></i></b-button>

              <b-button variant="primary" class="btn-sm float-right ml-1" v-b-tooltip.hover title="Export as PDF"
                v-on:click.prevent="downloadPDF('download_PDF')"><i class="fas fa-fw fa-file-pdf"></i></b-button>
