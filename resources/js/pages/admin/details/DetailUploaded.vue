            ...
            <form enctype="multipart/form-data">
              <div class="">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="format">Contributor Type</label>
                      <textarea
                        class="form-control"
                        id="format"
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="contributor">Department</label>
                      <textarea
                        class="form-control"
                        id="contributor"
  ...
  methods: {
   ...
   let formData = new FormData();
    ...
    onUpdate() {
      ...
      formData.append("contributor_type", this.form.contributor_type);
    ...
    getMyUpload() {
      ...
      axios.get("/api/upload-form/" + this.id).then((res) => {
        ...
        this.form.contributor_type = res.data.data.form.upload_form_creator.map(
          ({ contributor_type }) => contributor_type
        );
        this.form.department = res.data.data.form.upload_form_department.map(
